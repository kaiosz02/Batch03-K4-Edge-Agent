...
- **Nâng cấp 1 — Thêm nút "Bỏ qua thử thách" (Áp dụng HAX Principle G8):**  
  *Trỏ về feedback của Trịnh Bá Khánh Trình:* Bổ sung nút **"Bỏ qua thử thách"** trên Popup Quiz. Cho phép học viên ngay lập tức bypass bài quiz để chuyển sang luồng hỏi đáp Tutor giải thích trực tiếp.
- **Nâng cấp 2 — Cơ chế khóa thử thách 1 phút chống Brute-force (Domain Risk §5):**  
  *Trỏ về feedback của Phạm Xuân Phong:* Nếu học viên bấm chọn sai đáp án quá 3 lần liên tiếp trong một câu hỏi, hệ thống sẽ tạm thời **Khóa thử thách 1 phút** và không cộng EXP, ngăn chặn triệt để hành vi click lụi cày level.
...
| :--- | :--- | :--- |
| **Mẫu feedback ≥ 5 có tên + quote nguyên văn (4 điểm)** | **ĐẠT (5/5 mẫu)** — 3 Willing Users (Trình, Vũ, Phong) + 2 User ngoài nhóm (Tuyết, Việt). Đủ tên, vai trò, task, quan sát và quote nguyên văn trả lời 3 câu hỏi CP5. | Bảng tại Mục 2 của file này & Slide 5 presentation (`slide_6_trang.md`). |
