...
- **MSSV:** 2A202601836
- **Vai trò:** Viết báo cáo spec, tổng hợp slide thuyết trình 6 trang, thiết kế kịch bản demo/Q&A, đóng góp ý tưởng sản phẩm cùng các thành viên.
...
- **Tổng hợp & Hoàn thiện Báo cáo AI Spec (`spec.md`):**
  - Tổng hợp số liệu data mining từ 1.261 turns chatlog và khảo sát (N=40): 28.4% câu hỏi thụ động "Giải thích đoạn bôi đen", 39.02% lười tư duy, 46.15% thiếu trích dẫn trang.
  - Biên soạn mục §1 (User & Job), §2 (Bảng Impact chọn/loại 3 ứng viên tính năng), §3 (Nghiên cứu giải pháp tương tự Duolingo & Khanmigo), §4 (Lát cắt 1 câu & HAX/PAIR principles).
